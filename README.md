...
This Lambda function fetches restaurant menu items based on user-provided nutritional goals (e.g., protein, carbs, fat, energy). It uses OpenAI's GPT API to generate recommendations and retrieves secure parameters (API keys, model settings) from AWS SSM Parameter Store. The function handles HTTP requests and responses using Spring WebFlux.
